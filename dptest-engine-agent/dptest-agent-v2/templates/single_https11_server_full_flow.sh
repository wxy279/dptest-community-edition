...
curl_json POST "$BASE_URL/v2/projects/$PROJECT_ID/load-profiles" "{\"load_profile_id\":\"$LOAD_ID\",\"name\":\"baseline\",\"stress_type\":\"run\",\"stress_mode\":\"SimUsers\",\"max_connection_attemps\":9223372036854775807,\"stages\":[{\"stage\":\"delay\",\"repetitions\":1,\"height\":0,\"ramp_time\":0,\"steady_time\":20},{\"stage\":\"ramp up\",\"repetitions\":1,\"height\":2,\"ramp_time\":2,\"steady_time\":2},{\"stage\":\"stair step\",\"repetitions\":1,\"height\":2,\"ramp_time\":2,\"steady_time\":2},{\"stage\":\"steady State\",\"repetitions\":1,\"height\":10,\"ramp_time\":2,\"steady_time\":60},{\"stage\":\"ramp down\",\"repetitions\":1,\"height\":0,\"ramp_time\":6,\"steady_time\":0}]}" | pretty
